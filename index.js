...
app.get('/hotels/sort/pricing', (req, res) => {
  ...
  if (pricing == 'low-to-high') {
    sortedHotels.sort(function (stock1, stock2) {
...
app.get('/hotels/sort/rating', (req, res) => {
  ...
  if (rating == 'low-to-high') {
    sortedHotels.sort(function (stock1, stock2) {
      return stock1.rating - stock2.rating;
    });
  } else {
    sortedHotels.sort(function (stock1, stock2) {
      return stock2.rating - stock1.rating;
    });
  }
...
app.get('/hotels/sort/reviews', (req, res) => {
  ...
  if (reviews == 'least-to-most') {
    sortedHotels.sort(function (stock1, stock2) {
      return stock1.reviews - stock2.reviews;
    });
  } else {
    sortedHotels.sort(function (stock1, stock2) {
      return stock2.reviews - stock1.reviews;
    });
  }
